// 获取url二级目录
var pathname = window.location.pathname; // console.log(window.location);
//更多配置请参考:public\ueditor\ueditor.config.js
// 默认配置

export var ueditorConfig = {
  // 编辑器层级的基数,默认是900
  zIndex: '10',
  ...
  serverUrl: "/travel/system/oss/upload",
  ...
  'indent', //首行缩进
  '|', //对齐方式
  'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|', 'touppercase', //字母大小
  'tolowercase', //字母小写
  '|', 'link', //添加链接
  'unlink', //取消链接
  // 'anchor', //锚点
